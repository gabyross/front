...
const NewIngredient = () => {
  ...
  const [existingIngredients] = useState([
  ...
  const validateField = (fieldName, value) => {
    switch (fieldName) {
      case 'name':
        ...
        if (existingIngredients.includes(value.trim().toLowerCase())) {
      ...
      case 'measurementUnit':
        ...
        if (!measurementUnits.some(unit => unit.value === value)) {
